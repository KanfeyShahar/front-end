...
const ActionBar = ({ modal, toggleModal, getTerm,friend, selected, type,date,toggleModalHelp }) => {
  ...
  return (
    ...
    <div class="btn-group" role="group" aria-label="First group">
       ...
       <ComponentToPrint ref={componentRef} friend={friend} selected={selected} type={type}  />
       </div>
      ...
      <ButtonAdd header="בחר חבר עמותה לאירוע">
        <AddDriverEvents  date={date}/>
      </ButtonAdd>
      <button className={classes.button}>
