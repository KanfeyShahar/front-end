...
import HelpEquipments from "./Help/HelpRooms1"
            ...
            <table className="table table-striped table-hover">
              ...
              {this.props.hall.map((x)=>(
                    <tr>
                      ...
                      <td>{new Date(x.end).toLocaleDateString("en-GB")}</td>
...
const ActionBar = ({ modal, toggleModal, getTerm, hall,first, end,toggleModalHelp, direction}) => {
