...
const MainNavigation = () => {
  ...
  @import url('https://fonts.googleapis.com/css2?family=Rubik:wght@600&display=swap');
      ...
      <MainHeader>
        <div>
      <NavIcon to ="#">
        {auth.isLoggedIn &&<FaBars onClick={showSidebar} />}
        </NavIcon>
        </div>
        <div>
        ...
        {auth.isLoggedIn &&<Tope to = "/home"> כנפי שחר </Tope>}
        {!auth.isLoggedIn && <Tope to ="/">כנפי שחר</Tope>}
        ...
        {auth.isLoggedIn && <NavBtn onClick={auth.logout}>
         <NavBtnLink to="/">התנתקות</NavBtnLink>
        </NavBtn>}
      </MainHeader>
    </Fragment>
  );
