...
import HelpEquipments from "./Help/HelpEvents"
import classes from "./button.module.css";
import classes1 from "./report.module.css";


const ActionBar = ({ modal, toggleModal, getTerm,toggleModalDocumentEvent,documentEvent,toggleModalHelp }) => {;
